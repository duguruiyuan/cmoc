...
public class HttpClientUtils {
	...
	private static String invokePost(String url, Object params, String charset) throws IOException {
        ...
        return invokePost(url, map, charset);
	}
	
	private static String invokePost(String url, Map<String, String> params, String charset) throws IOException {
		if (charset == null || charset.isEmpty()) {
			charset = DEFAULT_CHARSET;
		}
        LOG.info(">>httpclient post send url={},params={}",url, params);
