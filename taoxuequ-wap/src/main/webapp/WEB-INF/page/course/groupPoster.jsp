...
<body>
	...
	<div>
		...
		<div class="mui-content">
			<form id="courseSignForm" class="mui-form">
				...
				<label>小孩性别：</label>
				<div class="mui-radio">
	                <input type="radio" style="padding-top: 10px;left: 0;top: -4px;" class="check" name="payType" value="ChinaPlay" checked="checked">
	            	<label class="pl30 pt10">男</label>
	            </div>
	            <div class="mui-radio" style="padding-top: 20px;">
	                <input type="radio" style="padding-top: 10px;left: 0;" class="check" name="payType" value="ChinaPlay">
	...
	<div class="group-tips">
		...
		<div class="group-tips-pannel1">
		 <b>一、家长的权利与义务</b><br/>
		　    1、报名时，家长应向主办方承诺其提供的个人及小朋友的身份信息全部为真实的。不得隐瞒参赛小朋友的重大疾病史，否则，由此导致参赛小朋友的人身安全与主办方无关。<br/>
		...
		　    3、报名后，家长原则上不得要求退出。家长如要求退出的，应至迟不得晚于活动日期前7天向主办方提出书面申请，主办方收到该申请后，有权要求该家长推荐另外一名小朋友报名参加，或要求该家长取得本组其它全部家长的书面自愿推迟活动日期的承诺。
			...
			上款所称的不可抗力是指，在活动路线的任何一处或会场地，发生了在报名时主办方不能预见、不能避免并不能克服的客观情况。包括但不限于自然灾害，如台风、冰雹、地震、海啸、洪水、火山爆发、山体滑坡、其它恶劣天气等；政府行为，如征收、征用、法律及政策的变更；社会异常事件，如战争、武装冲突、罢工、骚乱、暴动、流行病等情况。<br/>
